          ...
          {!isEditing ? (
            ...
            <>
              <button
                onClick={handleSave}
                disabled={loading}
                className="flex items-center gap-2 bg-green-700 text-white px-4 py-2 rounded-md hover:bg-green-800 transition disabled:opacity-50"
              >
        ...
        <div className="relative h-64 bg-gray-100">
          ...
          {isEditing && (
            <div className="absolute bottom-4 right-4">
              <label className="bg-white px-4 py-2 rounded-md shadow cursor-pointer hover:bg-gray-50 transition text-sm font-medium">
                <input
                  type="file"
                  accept="image/*"
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="pt-6 border-t border-gray-200">
            <div className="flex justify-between items-center mb-4">
              ...
              {isEditing && (
                <label className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-md cursor-pointer hover:bg-blue-700 transition text-sm">
